...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <form action="<%=path%>/goods/goodsInfoUpdate_submit?id=${entity.id}&image_path=${entity.image_path}" method="post" enctype="multipart/form-data">
<%--                <input type="hidden" name="id" value="${entity.id }">--%>
<%--                <input type="hidden" name="image_path" value="${entity.image_path }">--%>
                <div class="form-group">
                    <label>商品名</label>
                    <input type="text" name="name" value="${entity.name }" class="form-control" placeholder="请输入商品名称">
                </div>
                <div class="form-group">
                    <label>价格</label>
                    <input type="text" name="price" value="${entity.price }" class="form-control" placeholder="请输入商品的价格(两位小数)">
                </div>
                <div class="form-group">
                    <label>作者</label>
                    <input type="text" name="author" value="${entity.author }" class="form-control" placeholder="请输入商品的作者">
                </div>
                <div class="form-group">
                    <label>得分</label>
                    <input type="text" name="score" value="${entity.score }" class="form-control" placeholder="请输入商品的评价得分(一位小数，0~10)">
                </div>
                <div>
                    <label>商品类型</label>
                ...
                <div class="form-group">
                    <label>描述</label>
                    <textarea class="form-control" name="description" value="${entity.description }" rows="5" placeholder="请输入商品的描述信息（150字以内）"></textarea>
                </div>
                <div>
                    <label>上传封面图片</label>
